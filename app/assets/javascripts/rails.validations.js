(function() {
  ...
  window.ClientSideValidations.validators = {
    ...
    local: {
      ...
      length2: function(element, options) {
        var CHECKS, blankOptions, check, fn, message, operator, tokenized_length;
        tokenized_length = new Function('element', "return (element.val() || '').length2()")(element);
        CHECKS = {
          is: '==',
          minimum: '>=',
          maximum: '<='
